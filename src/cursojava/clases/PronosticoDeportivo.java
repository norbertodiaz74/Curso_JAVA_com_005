...
public class PronosticoDeportivo {
    ...
    public Partido[] cargarPartidos() {
        ...
        // maxima de partidos es la cantidad de equipos / 2
    ...
    public void cargarPronosticos() {
        ...
        for (int participante = 0; participante < this.getParticipantes().length; participante++) {
            ...
            for (int partido = 0; partido < this.getPartidos().length; partido++) {
                ...
                switch (equipoRnd) {
                    case 0:
                        equipoApuesta = this.getPartidos()[partido].getEquipo1();
                        break;
                    default:
                        equipoApuesta = this.getPartidos()[partido].getEquipo2();
                        break;
                }
                ...
                // Cargar el pronostico en el array de pronosticos
                prons[partido] = pron;
            }
